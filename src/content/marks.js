...
function injectTargetWidget(container, currentObtained, currentWeightage, finalExamWeight) {
    ...
    widget.className = 'aegis-target-widget bg-slate-50 border border-slate-200 rounded-lg p-4 mb-4 shadow-sm flex flex-col md:flex-row items-center justify-between gap-4 font-sans';
    ...
    select.className = 'border border-slate-300 rounded p-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none';
